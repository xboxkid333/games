...
function LoadJSCodeBlob(e, t, n) {
    ...
    n && (Module.blobInfo || (Module.blobInfo = {}),
    Module.blobInfo[i] = n),
    o.src = i,
    o.onload = function() {
    ...
    return function e(t, n, o) {
                ...
                n = 0; s > n; )
                    ...
                    r > 4)
                        ...
                        for (a &= 2 === r ? 31 : 3 === r ? 15 : 7; r > 1 && s > n; )
                            a = a << 6 | 63 & e[n++],
                            r--;
                        r > 1 ? l[i++] = 65533 : 65536 > a ? l[i++] = a : (a -= 65536,
                        l[i++] = 55296 | a >> 10 & 1023,
                        l[i++] = 56320 | 1023 & a)
                    }
                return o(l, i)
        ...
        8: [function(e, t, n) {
            ...
            function f(e, t) {
                ...
                n.hold = f,
                n.bits = h,
                (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < de || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out) ? (n.mode = fe,
                U) : (m -= e.avail_in,
                p -= e.avail_out,
                e.total_in += m,
                e.total_out += p,
        ...
        "/lib/inflate.js": [function(e, t, n) {
            ...
            h.prototype.push = function(e, t) {
                ...
                do {
                    ...
                    n !== d.Z_STREAM_END && n !== d.Z_OK)
                        ...
                        this.ended = !0,
                        !1;
                    c.next_out && (0 === c.avail_out || n === d.Z_STREAM_END || 0 === c.avail_in && (o === d.Z_FINISH || o === d.Z_SYNC_FLUSH)) && ("string" === this.options.to ? (i = s.utf8border(c.output, c.next_out),
                    l = c.next_out - i,
                ...
                o === d.Z_FINISH ? (n = a.inflateEnd(this.strm),
                this.onEnd(n),
                this.ended = !0,
                n === d.Z_OK) : o === d.Z_SYNC_FLUSH ? (this.onEnd(d.Z_OK),
                c.avail_out = 0,
                !0) : !0
            }
            ,
            ...
            h.prototype.onEnd = function(e) {
                e === d.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = r.flattenChunks(this.chunks)),
                this.chunks = [],
                this.err = e,
